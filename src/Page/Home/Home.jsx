...
import sunB from '../../.../../assets/background/sun.jpg'; // чистое небо   01d
...
const Home = () => {
  ...
  const handleChangeCity = (evenet) => {
    setCityName(evenet.target.value);
    // console.log(evenet);
  };
  ...
  const Gif = (props) => {
    ...
    return <img src={img} className='gifBackground'></img>;
  }
      ...
      <div className='' >
        <div className='background'>
          {catLength.map((items, index) => {
            ...
            return (
              <div>
                <Gif weatherIcon={weatherIcon} key={index} />
